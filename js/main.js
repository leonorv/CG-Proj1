...
function addLamps() {
    ...
    son.wires[5].addCylinderLamp(2, 2, 5, 30);
...
function createScene() {
    ...
    father.wires.push(new Wire(5*un, scene));
    ...
    son.wires[0].setPos(0, -father.wires[1].h/2, son.wires[0].h/2, -Math.PI/2, Math.PI, 0);
    ...
    son.wires.push(new Wire(un, scene));
    son.addWire(1, 5, 0, ((Math.sqrt(2)/4)*son.wires[5].h + son.wires[1].h/2), -((Math.sqrt(2)/4)*son.wires[5].h), Math.PI/2, Math.PI/2, Math.PI/4);
    
    mobile.addGroup(son);
    mobile.groups[0].wires[1].add(mobile.groups[1].wires[0]);

    grandson.wires.push(new Wire(3/2*un, scene));
    ...
    grandson.wires.push(new Wire(un, scene));
    grandson.addWire(1, 3, 0, grandson.wires[1].h/2, -grandson.wires[3].h/2, Math.PI/2, 0, 0);
    grandson.wires.push(new Wire(un, scene));
